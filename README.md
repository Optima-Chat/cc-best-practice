...
多数人使用 Claude Code 的方式是错的：直接要求写代码，写到一半发现方案不对，推倒重来，反复返工。

正确做法：先讨论技术方案，理解所有细节，确认无误后再写代码。讨论方案 1-2 小时，写代码 10-20 分钟。如果方案没想好就动手，返工时间可能是几小时甚至几天。
...
**画图：** 要求 Claude Code 画架构图、数据流图、时序图、ER 图。图比文字直观，保存到 docs 目录作为技术文档。
